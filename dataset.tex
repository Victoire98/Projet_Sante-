...
\hypersetup{unicode=true,
            pdftitle={Dataset\_Neiss},
            pdfauthor={Arias Bonaud Peres},
            pdfborder={0 0 0},
            breaklinks=true}
...
\NormalTok{data}\OperatorTok{$}\NormalTok{body_part <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(data}\OperatorTok{$}\NormalTok{body_part)}
\NormalTok{data}\OperatorTok{$}\NormalTok{location <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(data}\OperatorTok{$}\NormalTok{location)}
\CommentTok{#change others columns ....}
\KeywordTok{str}\NormalTok{(data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(data}\OperatorTok{$}\NormalTok{location,}\DataTypeTok{xlab =} \StringTok{"injure location"}\NormalTok{, }\DataTypeTok{main =} \StringTok{"Barplot"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{dataset_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(data}\OperatorTok{$}\NormalTok{location)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##  Factor w/ 9 levels "Farm","Home",..: 7 5 2 2 2 7 2 2 2 7 ...
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sport <-}\StringTok{ }\NormalTok{data[}\KeywordTok{which}\NormalTok{(data}\OperatorTok{$}\NormalTok{location }\OperatorTok{==}\StringTok{ "Sports Or Recreation Place"}\NormalTok{),]}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p <-}\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(sport}\OperatorTok{$}\NormalTok{sex, }\DataTypeTok{main =}\StringTok{"Only sports"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(sport}\OperatorTok{$}\NormalTok{body_part)}
\KeywordTok{plot}\NormalTok{(sport}\OperatorTok{$}\NormalTok{body_part,sport}\OperatorTok{$}\NormalTok{sex)}
\end{Highlighting}
\end{Shaded}

\includegraphics{dataset_files/figure-latex/unnamed-chunk-5-1.pdf}
